...
# models模块需要的配置参数
# ===============================================================
SQLALCHEMY_DATABASE_URI = 'mysql://root:123456@127.0.0.1:3306/tour?charset=utf8'  # 连接的数据库
SQLALCHEMY_ECHO = True  # 是否显示SQL语句

# 折扣图片
TOUR_PICTURE_UPLOAD_FOLDER = '/static/system/tour_picture'  # 运行目录的相对目录，URL获取图片的路径
TOUR_PICTURE_BASE_PATH = '/Users/X/Dropbox/Code/tour/tour'  # pub运行文件的目录，图片的绝对路径使用
